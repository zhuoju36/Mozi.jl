...
function Quad(id,hid,node1,node2,node3,node4,material,t,membrane=true,bending=true)
    ...
    pt1 = (node4.loc+node1.loc)/2
    pt2 = (node1.loc+node2.loc)/2
    csys = CSys(o, pt1, pt2)
...
function integrateKm!(elm)
    ...
    function BtDB(x)
        ...
        K[1,3]=(-1/16)*(1 + η)^2*E₀/(1 - ν₀^2) + (1/32)*(1 - ξ)*(1 + ξ)*E₀*(1 - ν₀)/(1 - ν₀^2)
        K[1,4]=(1/16)*(1 - ξ)*(1 + η)*E₀*ν₀/(1 - ν₀^2) + (-1/32)*(1 + ξ)*(1 + η)*E₀*(1 - ν₀)/(1 - ν₀^2)
        K[1,5]=(-1/16)*(1 - η)*(1 + η)*E₀/(1 - ν₀^2) + (-1/32)*(1 - ξ)*(1 + ξ)*E₀*(1 - ν₀)/(1 - ν₀^2)
        K[1,6]=(-1/16)*(1 - ξ)*(1 + η)*E₀*ν₀/(1 - ν₀^2) + (-1/32)*(1 + ξ)*(1 - η)*E₀*(1 - ν₀)/(1 - ν₀^2)
        K[1,7]=(1/16)*(1 - η)*(1 + η)*E₀/(1 - ν₀^2) + (-1/32)*(1 + ξ)^2*E₀*(1 - ν₀)/(1 - ν₀^2)
        ...
        K[2,4]=(-1/32)*(1 + η)^2*E₀*(1 - ν₀)/(1 - ν₀^2) + (1/16)*(1 - ξ)*(1 + ξ)*E₀/(1 - ν₀^2)
        K[2,5]=(-1/32)*(1 - ξ)*(1 + η)*E₀*(1 - ν₀)/(1 - ν₀^2) + (-1/16)*(1 + ξ)*(1 - η)*E₀*ν₀/(1 - ν₀^2)
        K[2,6]=(-1/16)*(1 - ξ)*(1 + ξ)*E₀/(1 - ν₀^2) + (-1/32)*(1 - η)*(1 + η)*E₀*(1 - ν₀)/(1 - ν₀^2)
        K[2,7]=(1/16)*(1 + ξ)*(1 - η)*E₀*ν₀/(1 - ν₀^2) + (-1/32)*(1 + ξ)*(1 + η)*E₀*(1 - ν₀)/(1 - ν₀^2)
        K[2,8]=(-1/16)*(1 + ξ)^2*E₀/(1 - ν₀^2) + (1/32)*(1 - η)*(1 + η)*E₀*(1 - ν₀)/(1 - ν₀^2)
        K[3,1]=(-1/16)*(1 + η)^2*E₀/(1 - ν₀^2) + (1/32)*(1 - ξ)*(1 + ξ)*E₀*(1 - ν₀)/(1 - ν₀^2)
        ...
        K[3,5]=(1/16)*(1 - η)*(1 + η)*E₀/(1 - ν₀^2) + (-1/32)*(1 - ξ)^2*E₀*(1 - ν₀)/(1 - ν₀^2)
        ...
        K[4,2]=(-1/32)*(1 + η)^2*E₀*(1 - ν₀)/(1 - ν₀^2) + (1/16)*(1 - ξ)*(1 + ξ)*E₀/(1 - ν₀^2)
        ...
        K[4,6]=(-1/16)*(1 - ξ)^2*E₀/(1 - ν₀^2) + (1/32)*(1 - η)*(1 + η)*E₀*(1 - ν₀)/(1 - ν₀^2)
        ...
        K[5,2]=(-1/32)*(1 - ξ)*(1 + η)*E₀*(1 - ν₀)/(1 - ν₀^2) + (-1/16)*(1 + ξ)*(1 - η)*E₀*ν₀/(1 - ν₀^2)
        K[5,3]=(1/16)*(1 - η)*(1 + η)*E₀/(1 - ν₀^2) + (-1/32)*(1 - ξ)^2*E₀*(1 - ν₀)/(1 - ν₀^2)
        ...
        K[6,8]=(-1/32)*(1 - η)^2*E₀*(1 - ν₀)/(1 - ν₀^2) + (1/16)*(1 - ξ)*(1 + ξ)*E₀/(1 - ν₀^2)
        K[7,1]=(1/16)*(1 - η)*(1 + η)*E₀/(1 - ν₀^2) + (-1/32)*(1 + ξ)^2*E₀*(1 - ν₀)/(1 - ν₀^2)
        ...
        K[7,5]=(-1/16)*(1 - η)^2*E₀/(1 - ν₀^2) + (1/32)*(1 - ξ)*(1 + ξ)*E₀*(1 - ν₀)/(1 - ν₀^2)
        ...
        K[8,2]=(-1/16)*(1 + ξ)^2*E₀/(1 - ν₀^2) + (1/32)*(1 - η)*(1 + η)*E₀*(1 - ν₀)/(1 - ν₀^2)
        ...
        K[8,6]=(-1/32)*(1 - η)^2*E₀*(1 - ν₀)/(1 - ν₀^2) + (1/16)*(1 - ξ)*(1 + ξ)*E₀/(1 - ν₀^2)
