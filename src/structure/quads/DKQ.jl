...
function B_DKQ(elm::Quad,ξ,η)::Matrix{Float64}
...
function P_DKQ(elm::Quad,p)::Vector{Float64}
    A=elm.A
    P=zeros(24)
    #TODO P not correct
    P[3]=P[9]=P[15]=P[21]=p*A/4
end

function M_DKQ(elm::Quad,U,x,y)::Float64
    D₀=E₀*t^3/12/(1-ν₀^2)
    D=D₀*[1 ν₀ 0;
          ν₀ 1 0;
          0  0 (1-ν₀)/2]
...
function W_DKQ(elm::Quad,f)::Float64
    W=hcubature(w,[-1,-1],[1,1])[1]
end
